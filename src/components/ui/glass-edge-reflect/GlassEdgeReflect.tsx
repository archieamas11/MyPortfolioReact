...
export const GlassEdgeReflect = React.forwardRef<HTMLElement, GlassEdgeReflectProps>(
  function GlassEdgeReflect(
    ...
    const updateEdgeFxFromEvent = useCallback(
      ...
      return React.cloneElement(
        onlyChild,
        {
          ...
          onMouseEnter: (e: React.MouseEvent<HTMLElement>) => {
            ;(
              onlyChild.props as { onMouseEnter?: (ev: React.MouseEvent<HTMLElement>) => void }
            ).onMouseEnter?.(e)
            handleMouseEnter(e)
          },
          onMouseMove: (e: React.MouseEvent<HTMLElement>) => {
            ;(onlyChild.props as { onMouseMove?: (ev: React.MouseEvent<HTMLElement>) => void }).onMouseMove?.(
              e,
            )
            handleMouseMove(e)
          },
          onMouseLeave: (e: React.MouseEvent<HTMLElement>) => {
            ;(
              onlyChild.props as { onMouseLeave?: (ev: React.MouseEvent<HTMLElement>) => void }
            ).onMouseLeave?.(e)
            handleMouseLeave()
          },
        } as any,
