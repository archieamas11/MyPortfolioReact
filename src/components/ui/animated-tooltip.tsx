      ...
      <AnimatePresence mode="popLayout">
        {isHovered && !isMobile && (
          ...
          >
            ...
            <div className="border-t-foreground absolute bottom-0 left-1/2 h-0 w-0 -translate-x-1/2 translate-y-full transform border-t-4 border-r-4 border-l-4 border-transparent" />
          </motion.div>
        )}
      </AnimatePresence>
      <div className={cn(isHovered && 'z-30', className)} onMouseMove={handleMouseMove}>
        {children}
      </div>
    </div>
  )
