              ...
              >
                <AnimatedTooltip label={detail.label} value={detail.value}>
                  {detail.href ? (
                    ...
                    >
                      <div className="glass-effect flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-center text-primary transition-colors hover:bg-white/10 hover:shadow-md">
                        <Icon size={12} />
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-3 rounded-md py-3 transition-colors lg:gap-4 lg:py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="sr-only font-medium text-foreground text-sm">
                            {detail.label}
                          </div>
                          <div className="text-muted-foreground text-xs sm:text-sm">
                            {detail.value}
