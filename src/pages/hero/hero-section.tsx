      ...
      <div className="flex min-h-150 w-full max-w-7xl">
        <LazyMotion features={domAnimation}>
          ...
          >
            ...
            <div className="bg-effect bg-primary/10 from-accent/15 relative hidden h-65 w-full overflow-hidden rounded-t-3xl bg-linear-to-t to-transparent mask-[radial-gradient(150px_at_50%_0%,transparent_99%,black_100%)] backdrop-blur-2xl [-webkit-mask-image:radial-gradient(150px_at_50%_0%,transparent_99%,black_100%)] md:block">
            ...
            {/* Logo  */}
            <Coin3D enableIntro={shouldAnimate} isMobile={isMobile} logoSrc="/images/aaa-white.avif" />
